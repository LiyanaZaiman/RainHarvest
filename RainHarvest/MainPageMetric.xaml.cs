...
{
    public partial class MainPageMetric : ContentPage
    {
        FirebaseHelper firebaseHelper = new FirebaseHelper();

        public MainPageMetric()
        {
            InitializeComponent();
        ...
        void showCurrentRecord(object sender, EventArgs e)
        {
            ...
            {
                currentCalc.Text = "(xxxx.xx) X (xx.xx) X (xx.xx) X 0.623= xxx.xx gallons";
            }
            else
            {
        ...
        {
            /*public void InsertPageBefore(MainPageMetric page, MainPage before);*/
            await Navigation.PushAsync(new MainPageMetric(), true);
        }
    }
}
